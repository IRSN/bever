...
results or plots such as Return Level tables or plots. Its main goal
is to allow a comparison of the frequentist and Bayesian inference
methods when applied to EV models.
...
- For now it is possible to draw the predictive curve on the same
  ...
  transformation of plotting positions in "Renext style" to use them
  in "block style".
